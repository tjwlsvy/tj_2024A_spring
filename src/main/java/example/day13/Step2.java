...
public class Step2 {
    public static void main(String[] args) {
        ...
        System.out.println("48 보다 이상 = " + scores.tailSet(48 , true)); // true 이상 , false 초과
        System.out.println("48 보다 이하 = " + scores.headSet(48,true));
        System.out.println("10 이상 이면서 48 미만 = " + scores.subSet(10 , true , 48 , false));

        // 6. TreeMap
        TreeMap<Integer , String> treeMap = new TreeMap<>();
        // 7.
        treeMap.put(23 , "apple");
        treeMap.put(10 , "foreber");
        treeMap.put(48 , "ever");
        treeMap.put(15 , "base");
        treeMap.put(7 , "cherry");
        treeMap.put(22 , "quess");
        treeMap.put(56 , "zoo");
