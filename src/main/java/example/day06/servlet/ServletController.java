...
@WebServlet("/day06/servlet")   // http://localhost:8080/day06/servlet

public class ServletController extends HttpServlet {
    // extends : 상속(해당 클래스에 특정 클래스로부터 상속 받으면 해당 클래스는 특정 클래스로부터 모든 필듯/미소드 사용할수 있다)
        // - @Override : 오버라이딩 : 상속받은 클래스의 메소드 재정의
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // - 요청 데이터 : 매개변수처럼 HTTP 요청시 들어오는 데이터 , HTTP 요청정보 관련 객체 : HttpServletRequest
        // http://localhost:8080/day06/servlet?data=serverHi
        System.out.println(" request Data : "+req.getParameter("data"));
        // - 응답 데이터 : 리턴값처럼 HTTP 응답시 반환하는 데이터 , HTTP 응답정보 관련 객체 : HttpServletRequest
